...
Discuss the approach by Merkle. What is the time complexity for Jade to get the key using his approach?}  	
	...
	\item{\textit{[Computer Networks]}What are Wireless Sensor Networks (WSNs)? How do they differ from traditioinal home or office networks? What are the issues unique to WSNs?Give some example applications.}  	
